...
class TestYumConfig(unittest.TestCase):
    def setUp(self):
        ...
        repo = {
            'name': u'cl7-os',
            'url': (
                u'http://koji.cloudlinux.com/cloudlinux/7/updates'
                u'-testing/x86_64/'
            ),
        }
        yum_repos.append(
        ...
        self.yum_config = YumConfig(
            exclude=yum_exclude, rpmverbosity='info', repositories=yum_repos
        )
