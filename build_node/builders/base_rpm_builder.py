...
import rpm
import validators
from build_slave.base_builder import BaseBuilder, measure_stage
from build_slave.errors import (
    BuildConfigurationError,
    BuildError,
    BuildExcluded,
)
from build_slave.mock.error_detector import build_log_excluded_arch
from build_slave.mock.mock_config import (
...
from build_slave.mock.mock_environment import MockError
from build_slave.mock.yum_config import YumConfig, YumRepositoryConfig
from build_slave.utils.file_utils import download_file
from build_slave.utils.git_utils import (
    MirroredGitRepo,
    WrappedGitRepo,
    git_get_commit_id,
)
from build_slave.utils.index_utils import extract_metadata
from build_slave.utils.ported import to_unicode
from build_slave.utils.rpm_utils import unpack_src_rpm
from build_slave.utils.spec_parser import SpecParser, SpecSource
...
class BaseRPMBuilder(BaseBuilder):
    ...
    def __init__(
        ...
        """
        super(BaseRPMBuilder, self).__init__(
            config, logger, task, task_dir, artifacts_dir
        )
