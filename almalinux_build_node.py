...
from common_library.errors import BuildError, BuildExcluded
from common_library.utils.file_utils import chown_recursive, rm_sudo
from common_library.utils.spec_parser import SpecParseError
...
def init_args_parser():
    ...
    parser.add_argument(
        '-t', '--threads', type=int, help='build threads count'
    )
